...
var Ao = {
  ...
  funding: { type: 'opencollective', url: 'https://opencollective.com/kaplay' },
  repository: {
    type: 'git',
  ...
  scripts: {
    ...
    build:
      'node scripts/generateIndex.js && npm run doc-dts && node scripts/build.js',
...
var j = class t {
  ...
  static fromHSL(e, n, r) {
    ...
    let o = (p, b, l) => (
      ...
      u = o(i, s, e),
      c = o(i, s, e - 1 / 3);
    return new t(Math.round(m * 255), Math.round(u * 255), Math.round(c * 255));
  }
...
var tu = 1103515245,
  ...
  Xt = class {
    ...
    gen() {
      return ((this.seed = (tu * this.seed + nu) % Vo), this.seed / Vo);
    }
    genNumber(e, n) {
...
function Or(t, e) {
  if (et(e, t.p1) || et(e, t.p2)) return !0;
  for (let n = 0; n < e.pts.length; n++) {
    let r = e.pts[n],
      o = e.pts[(n + 1) % e.pts.length];
    if (Sn(t, new Oe(r, o))) return !0;
  }
  return !1;
}
function Gn(t, e) {
...
function Qt(t, e) {
  ...
  for (let r of e.pts) {
    if (Ft(new Oe(n, r), t)) return !0;
    n = r;
  }
  return Gn(t, e.pts[0]) ? !0 : et(e, t.center);
}
function Lo(t, e) {
...
function et(t, e) {
  ...
  for (let o = 0, s = r.length - 1; o < r.length; s = o++)
    r[o].y > e.y != r[s].y > e.y &&
      e.x < ((r[s].x - r[o].x) * (e.y - r[o].y)) / (r[s].y - r[o].y) + r[o].x &&
      (n = !n);
  return n;
}
function Ar(t, e) {
...
function su(t, e) {
  ...
  let n = new bt(1 / t.radiusX ** 2, 0, 0, 0, 1 / t.radiusY ** 2, 0, 0, 0, -1),
    r = new bt(1 / e.radiusX ** 2, 0, 0, 0, 1 / e.radiusY ** 2, 0, 0, 0, -1),
    o = t.center.x,
    s = t.center.y,
    i = e.center.x,
    m = e.center.y,
    ...
    Z =
      ...
      J,
    Ee =
      (G * U * K - G * H * _ - M * L * K + M * H * Y + D * L * _ - D * U * Y) /
      J;
  if ($ >= 0) {
    let k = -3 * Z + $ ** 2,
      gt = 3 * $ * Ee + Z * $ ** 2 - 4 * Z ** 2,
...
function hu(t, e, n) {
  let r = n.toMat2(),
    ...
    m = ko(s, i, new we(v(), 1));
  if (m) {
    let u = Dt.rotation(ae(-n.angle)),
      p = Dt.scale(n.radiusX, n.radiusY).transform(m.point),
      b = r.transform(m.point).add(n.center),
      l = b.dist(t) / e.len();
    return {
      point: b,
      normal: u.transform(v(n.radiusY ** 2 * p.x, n.radiusX ** 2 * p.y)).unit(),
      fraction: l,
    };
  }
  return m;
...
var On = class t {
  ...
  Ke = class t {
    ...
    static fromMat2(e) {
      ...
      return u > c
        ? new t(v(), u, c, lt(Math.atan2(-i[1], i[0])))
        : new t(v(), c, u, lt(Math.atan2(-m[1], m[0])));
    }
    toMat2() {
      let e = ae(this.angle),
        n = Math.cos(e),
...
function bu(t, e, n, r) {
  let o = 3 * t - 6 * e + 3 * n,
    ...
    m = -t + 3 * e - 3 * n + r;
  if (xr(m, 0)) {
    if (xr(o, 0)) return xr(s, 0) ? [] : [-i / s].filter(Yt);
    let y = Math.sqrt(s * s - 4 * o * i),
      O = 2 * o;
    return [(y - s) / O, (-s - y) / O].filter(Yt);
  }
  ((o /= m), (s /= m), (i /= m));
  let u = (3 * s - o * o) / 3,
    c = u / 3,
  ...
  if (l < 0) {
    ...
    return [G, M, D].filter(Yt);
  }
  if (l === 0) {
    let y = b < 0 ? $t(-b) : -$t(b),
      O = 2 * y - o / 3,
      A = -y - o / 3;
    return [O, A].filter(Yt);
  }
  let h = Math.sqrt(l),
    d = $t(h - b),
    C = $t(h + b);
  return [d - C - o / 3].filter(Yt);
}
function yu(t, e, n, r, o) {
  let s = bu(t.x - o, e.x - o, n.x - o, r.x - o);
  return s.length > 0 ? Jt(t, e, n, r, s[0]).y : NaN;
}
function Zo(t) {
  if (!t || t.length == 0)
...
function Mn(t) {
  ...
  ((e[e.length - 1] = 0), (n[0] = n.length - 1), xu(t) || ([e, n] = [n, e]));
  let o = [];
  for (let b = 0; b < t.length; ++b) rs(t[n[b]], t[b], t[e[b]]) || o.push(t[b]);
  let s = [],
    i = t.length,
    m = 1,
    u = 0,
  ...
  re = class {
    ...
    trigger(...e) {
      this.handlers.forEach((n) => {
        let r = n(...e),
          o;
        r === Dn && (o = this.cancellers.get(n)) && o();
      });
    }
    numListeners() {
...
function Mr(t, e) {
  Bn(t, 'data:text/plain;charset=utf-8,' + e);
}
function xs(t, e) {
...
function Rr(t, e) {
  ...
  (Bn(t, n), URL.revokeObjectURL(n));
}
var Fn = (t) => t.match(/^data:\w+\/\w+;base64,.+/);
...
function tt(t, e) {
  Ou(`${t} is deprecated. Use ${e} instead.`);
}
function on(t, e) {
...
function Bu(t) {
  return typeof t == 'string' && Au.includes(t.charCodeAt(0));
}
function Fu(t) {
...
var Vs = () => pt.lastInputDevice,
  Ps = () => {
    ...
    for (let e in t) {
      ...
      (n &&
        n.forEach((i) => {
          sn(pt.buttonsByKey, i, e);
        }),
        r &&
          r.forEach((i) => {
            sn(pt.buttonsByKeyCode, i, e);
          }),
        o &&
          o.forEach((i) => {
            sn(pt.buttonsByGamepad, i, e);
          }),
        s &&
          s.forEach((i) => {
            sn(pt.buttonsByMouse, i, e);
          }));
    }
  };
var vt = class {
  ...
  Ms = (t) => {
    ...
    function A(f, T) {
      ...
      let P = 0,
        ...
        te = (Ae) => {
          ...
          let se = Ae / 1e3,
            Ze = Math.min(se - e.realTime, 0.25),
            Rt = t.maxFPS ? 1 / t.maxFPS : 0;
          if (((e.realTime = se), (B += Ze), B > Rt)) {
            if (!e.skipTime) {
            ...
            ((B = 0), (e.skipTime = !1), e.numFrames++, T(Cn, Xa));
          }
          e.loopID = requestAnimationFrame(te);
        };
      te(0);
    ...
    function vo(f) {
      let T = {
        ...
        getStick: (P) => e.gamepadStates.get(f.index)?.stickState.get(P) || v(),
      };
      return (
        e.gamepads.push(T),
    ...
    function Ja() {
      ...
      for (let f of e.gamepads) {
        ...
        if (!T) continue;
        let B = (t.gamepads ?? {})[T.id] || Gs[T.id] || Gs.default,
          te = e.gamepadStates.get(f.index);
        if (te) {
          for (let Ae = 0; Ae < T.buttons.length; Ae++) {
            let se = B.buttons[Ae],
              Ze = T.buttons[Ae],
              Rt = e.buttonsByGamepad.has(se);
            if (Ze.pressed) {
          ...
          for (let Ae in B.sticks) {
            let se = B.sticks[Ae];
            if (!se) continue;
            let Ze = new E(T.axes[se.x], T.axes[se.y]);
            (te.stickState.set(Ae, Ze),
              e.mergedGamepadState.stickState.set(Ae, Ze),
              e.events.trigger('gamepadStick', Ae, Ze, f));
          }
        }
      }
    }
    let Me = {},
      ...
      wo = t.pixelDensity || 1;
    Me.mousemove = (f) => {
      let T = Qe(new E(f.offsetX, f.offsetY)),
      ...
      if (y()) {
        ...
        if (Ze > Rt) {
          let Re = se / te,
            yr = (Ae - B * Re) / 2;
          ((T.x = Se(f.offsetX - yr, 0, B * Re, 0, B)),
            (T.y = Se(f.offsetY, 0, te * Re, 0, te)));
        } else {
          let Re = Ae / B,
            yr = (se - te * Re) / 2;
          ((T.x = Se(f.offsetX, 0, B * Re, 0, B)),
            (T.y = Se(f.offsetY - yr, 0, te * Re, 0, te)));
        }
      }
    ...
    ((Me.keydown = (f) => {
          ...
          e.events.onOnce('input', () => {
            ...
            (t.touchToMouse !== !1 &&
              ...
              T.forEach((B) => {
                e.events.trigger(
                  'touchStart',
                  Qe(new E(B.clientX - P.x, B.clientY - P.y)),
                  B,
                );
              }));
          }));
      ...
      (En.gamepadconnected = (f) => {
        let T = vo(f.gamepad);
        e.events.onOnce('input', () => {
          e.events.trigger('gamepadConnect', T);
        });
      }),
      (En.gamepaddisconnected = (f) => {
        let T = zt().filter((P) => P.index === f.gamepad.index)[0];
        (Qa(f.gamepad),
          e.events.onOnce('input', () => {
    ...
    for (let [f, T] of Object.entries(br)) document.addEventListener(f, T);
    for (let [f, T] of Object.entries(En)) window.addEventListener(f, T);
    ...
    return (
      To.observe(e.canvas),
      {
        ...
        onHide: ve,
        onShow: qt,
        onGamepadButtonDown: dr,
        onGamepadButtonPress: ut,
        onGamepadButtonRelease: fr,
        onGamepadStick: hr,
        onGamepadConnect: gr,
        onGamepadDisconnect: wn,
        onButtonPress: Ie,
        onButtonDown: Wt,
        onButtonRelease: Je,
        getLastInputDeviceType: Vs,
        events: e.events,
      }
    );
  };
...
var In = 2.5949095,
  ...
  Kn = {
    ...
    easeInBack: (t) => Bs * t * t * t - 1.70158 * t * t,
    easeOutBack: (t) =>
      1 + Bs * Math.pow(t - 1, 3) + 1.70158 * Math.pow(t - 1, 2),
    easeInOutBack: (t) =>
      t < 0.5
        ? (Math.pow(2 * t, 2) * ((In + 1) * 2 * t - In)) / 2
        : (Math.pow(2 * t - 2, 2) * ((In + 1) * (t * 2 - 2) + In) + 2) / 2,
    easeInElastic: (t) =>
      t === 0
        ? 0
        : t === 1
          ? 1
          : -Math.pow(2, 10 * t - 10) * Math.sin((t * 10 - 10.75) * Fs),
    easeOutElastic: (t) =>
      t === 0
        ? 0
        : t === 1
          ? 1
          : Math.pow(2, -10 * t) * Math.sin((t * 10 - 0.75) * Fs) + 1,
    easeInOutElastic: (t) =>
      t === 0
        ? 0
        : t === 1
          ? 1
          : t < 0.5
            ? -(Math.pow(2, 20 * t - 10) * Math.sin((20 * t - 11.125) * Ls)) / 2
            : (Math.pow(2, -20 * t + 10) * Math.sin((20 * t - 11.125) * Ls)) /
                2 +
              1,
    easeInBounce: (t) => 1 - Kn.easeOutBounce(1 - t),
    easeOutBounce: (t) =>
      t < 1 / 2.75
        ? 7.5625 * t * t
        : t < 2 / 2.75
    ...
    easeInOutBounce: (t) =>
      t < 0.5
        ? (1 - Kn.easeOutBounce(1 - 2 * t)) / 2
        : (1 + Kn.easeOutBounce(2 * t - 1)) / 2,
  },
  nt = Kn;
function Wu(t, e, n) {
  let r = [],
...
function Lr(t, e, n) {
  let r = new It((i, m) => i.cost < m.cost);
...
function pe(t) {
  return typeof t != 'string' || Fn(t) ? t : a.assets.urlPrefix + t;
}
var ce = class t {
    loaded = !1;
    data = null;
...
function Hs(t, e) {
  return a.assets.custom.add(t, Et(pe(e)));
}
function Tt(t) {
  let e = new Image();
  return (
...
var Fe = class t {
  ...
  static fromURL(e, n = {}) {
    return Tt(e).then((r) => t.fromImage(r, n));
  }
};
function Kt(t) {
  if (typeof t == 'string') {
    ...
    Array.isArray(e)
      ? e.some((r) => typeof r == 'string')
        ? a.assets.sprites.add(
            t,
            Promise.all(
              e.map((r) => (typeof r == 'string' ? Tt(r) : Promise.resolve(r))),
            ).then((r) => Ys(r, n)),
          )
        : a.assets.sprites.addLoaded(t, Ys(e, n))
      : typeof e == 'string'
...
function Xs(t, e, n) {
  ...
  let r = typeof n == 'string' ? Et(n) : Promise.resolve(n);
...
function Zs(t, e, n, r, o = {}) {
  ...
  return a.assets.bitmapFonts.add(
    t,
    Tt(s).then((i) => Js(Ve.fromImage(a.gfx.ggl, i, o), n, r, o.chars ?? Rn)),
  );
}
function ei(t, e) {
  return (
    ...
    a.assets.sprites.add(
      t,
      new Promise(async (n) => {
        let r = typeof e == 'string' ? await Et(e) : e,
          o = await Promise.all(r.frames.map(Tt)),
...
function qn(t, e = tn, n = nn) {
  let r = cs.replace('{{user}}', e ?? tn),
    o = ls.replace('{{user}}', n ?? nn);
  try {
    return new zr(
      t,
      r,
...
function ni(t, e, n) {
  return a.assets.shaders.addLoaded(t, qn(a.gfx.ggl, e, n));
}
function ri(t, e, n) {
  ((e = pe(e)), (n = pe(n)));
  let r = (s) => (s ? _s(s) : Promise.resolve(null)),
    o = Promise.all([r(e), r(n)]).then(([s, i]) => qn(a.gfx.ggl, s, i));
...
var ot = class t {
  ...
  static fromURL(e) {
    return Fn(e)
      ...
      : Ns(e).then((n) => t.fromArrayBuffer(n));
  }
};
function oi(t) {
  if (typeof t == 'string') {
    ...
    if (t instanceof ot) return ce.loaded(t);
    if (t instanceof ce) return t;
...
function si(t, e) {
  return (
    ...
    a.assets.sounds.add(
      t,
      typeof e == 'string' ? ot.fromURL(e) : ot.fromArrayBuffer(e),
    )
  );
}
function ii(t, e) {
...
function Pe(t) {
  ...
  if (!(e < 3)) {
    if (
      (ge(), X(t.pos), rt(t.scale), Ye(t.angle), X(t.offset), t.fill !== !1)
    ) {
...
function zn(t) {
  ...
  let e = t.start ?? 0,
    ...
    o = wt(r, t.radiusX, t.radiusY, e, n, t.resolution);
  o.unshift(r);
...
function $u(t) {
  ...
  for (let d = 1; d < e.length; d++) {
    ...
    let A = y.sub(u).cross(C) / O,
      R = u.add(i.scale(A));
    (O > 0
      ? (n.push(c.add(R)), n.push(c.sub(u)), n.push(c.add(R)), n.push(c.sub(y)))
      : (n.push(c.add(u)),
        n.push(c.sub(R)),
        n.push(c.add(y)),
        n.push(c.sub(R))),
  ...
  if (!(e.length < 2)) {
    ...
    if (t.radius && e.length >= 3) {
      ...
      for (let r = 1; r < e.length - 2; r++) {
        let o = e[r],
          s = e[r + 1];
        _t(Object.assign({}, t, { p1: o, p2: s }));
      }
      _t(Object.assign({}, t, { p1: e[e.length - 2], p2: e[e.length - 1] }));
    } else
      for (let r = 0; r < e.length - 1; r++)
        (_t(Object.assign({}, t, { p1: e[r], p2: e[r + 1] })),
          t.join !== 'none' &&
...
function ui(t, e = {}) {
  ...
  let [m, u] = St((V) => t.bindTexture(t.TEXTURE_2D, V)),
    [c, p] = St((V) => t.bindBuffer(t.ARRAY_BUFFER, V)),
    [b, l] = St((V) => t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, V)),
    [h, d] = St((V) => t.bindFramebuffer(t.FRAMEBUFFER, V)),
    [C, g] = St((V) => t.bindRenderbuffer(t.RENDERBUFFER, V)),
    [y, O] = St((V) => {
      if (!V) return;
      let { x, y: w, w: S, h: G } = V;
      t.viewport(x, w, S, G);
    }),
    [A, R] = St((V) => t.useProgram(V));
  return (
...
function Ue(t) {
  ...
  let { charStyleMap: n, text: r } = $n(t.text + ''),
    o = Ts(r);
  if (e instanceof At || typeof e == 'string') {
    let A = e instanceof At ? e.fontface.family : e,
      R =
        e instanceof At
          ? { outline: e.outline, filter: e.filter }
          : { outline: null, filter: Zt },
      V = Xr[A] ?? {
        font: {
...
`
  ...
  for (let A = 0; A < l.length; A++) {
    let R = (p - l[A].width) * Rs(t.align ?? 'left');
    for (let V of l[A].chars) {
      ...
      if (
        ...
        let S =
          typeof t.transform == 'function' ? t.transform(w, V.ch) : t.transform;
        S && mi(V, S);
      }
      if (n[w]) {
        let S = n[w];
...
function it(t) {
  ...
  let e = t.width,
    n = t.height,
    o = _e(t.anchor || mt).scale(new E(e, n).scale(-0.5)),
...
function xe(t) {
  ...
  if (t.radius) {
    ...
    s = [
      new E(m[0], 0),
      ...(m[1] ? wt(new E(e - m[1], m[1]), m[1], m[1], 270, 360) : [v(e, 0)]),
      ...(m[2] ? wt(new E(e - m[2], n - m[2]), m[2], m[2], 0, 90) : [v(e, n)]),
      ...(m[3] ? wt(new E(m[3], n - m[3]), m[3], m[3], 90, 180) : [v(0, n)]),
      ...(m[0] ? wt(new E(m[0], m[0]), m[0], m[0], 180, 270) : []),
    ];
  }
  Pe(
    Object.assign({}, t, {
      ...
      : (typeof t == 'object' &&
          ...
          (r += [
            ...
            (o = Object.getOwnPropertyNames(t)
              .map(
                (s) =>
                  `${/^\w+$/.test(s) ? s : JSON.stringify(s)}: ${Jr(t[s], !0, n.union(new Set([t])))}`,
              )
              .join(', '))
              ? ` ${o} `
              : '',
...
function fi() {
  ...
  ((t.shake = de(t.shake, 0, 5 * ee())),
    (t.transform = new fe()
      ...
      .scale(t.scale)
      .rotate(t.angle)
      .translate((t.pos ?? Ct()).scale(-1).add(e))),
    a.game.root.draw(),
    Ce());
}
function hi() {
  ...
  a.game.events.numListeners('loading') > 0
    ...
    : qe(() => {
        ...
        (xe({ pos: v(0), width: ie(), height: ue(), color: I(0, 0, 0) }),
          xe({ pos: r, width: e, height: n, fill: !1, outline: { width: 4 } }),
...
var xi = (t, e) => {
  let n = qn(e, tn, nn),
    ...
    m =
      t.width && t.height
        ? new st(e, t.width * r * o, t.height * r * o)
        : new st(e, s.drawingBufferWidth, s.drawingBufferHeight),
    u = null,
    c = 1;
  (t.background &&
...
function Ti(t = 1, e = I(0, 0, 0), n = 1, r = 'miter', o = 10, s = 'butt') {
  return {
    id: 'outline',
    outline: { width: t, color: e, opacity: n, join: r, miterLimit: o, cap: s },
    inspect() {
...
function Vi(t, e) {
  ...
  let n = a.game.root.add([Pt(e.pos ?? v(0))]),
    r = t.length,
    o = 0,
    s = null,
    i = null,
    ...
    V = {
      ...
      spawn(x, ...w) {
        ...
        (M || G.push(Pt(this.tile2Pos(S))), D || G.push(nr()));
        let L = n.add(G);
        return (
        ...
        let S = this.toWorld(x),
          ...
          L = _o(
            ...
            (U) => {
              ...
              return (
                Y && (Y.point = this.fromWorld(Y.point).scale(M)),
                Y || !1
              );
            },
            64,
      ...
      getTilePath(x, w, S = {}) {
        ...
        let D = new It((K, J) => K.cost < J.cost);
...
function Ge(t, e, n) {
  return (
    a.game.objEvents.registers[t] || (a.game.objEvents.registers[t] = new rn()),
...
function zi(t) {
  if (a.assets.loaded) Un().forEach((e) => t(...e));
...
function oo() {
  return a.game.cam.pos ? a.game.cam.pos.clone() : Ct();
}
function so(...t) {
...
function co(t = I(255, 255, 255), e = 1) {
  let n = a.game.root.add([tr(ie(), ue()), Jn(t), Zn(1), ar()]),
    r = n.fadeOut(e);
...
function Qi(...t) {
  return (
    tt('camScale', 'setCamScale / getCamScale'),
    t.length > 0 && so(...t),
    io()
  );
}
function Ji(t) {
  return (tt('camRot', 'setCamRot / getCamRot'), t !== void 0 && ao(t), uo());
}
  ...
  let e = new Map(),
    ...
    p = {
      ...
      readd(l) {
        ...
        return (
          h !== -1 && (this.children.splice(h, 1), this.children.push(l)),
          l
        );
      },
      remove(l) {
      ...
      isAncestorOf(l) {
        return l.parent ? l.parent === this || this.isAncestorOf(l.parent) : !1;
      },
      exists() {
...
var ea = () => ({
  ...
  defaultLayerIndex: 0,
  logs: [],
  cam: { pos: null, scale: new E(1), angle: 0, shake: 0, transform: new fe() },
});
function ta(t) {
...
var sa = () =>
  (() => {
    ...
    return (
      e
        .decodeAudioData(oa.buffer.slice(0))
        .then((o) => {
          r.buf = o;
        })
        .catch((o) => {
...
function ua(t) {
  return (tt('volume', 'setVolume / getVolume'), t !== void 0 && lo(t), mo());
}
function cr() {
  (a.app.onHide(() => {
    ...
    a.globalOpt.debug !== !1 &&
      ...
      a.app.onKeyPress('f7', () => {
        a.debug.timeScale = on(Te(a.debug.timeScale - 0.2, 0, 2), 1);
      }),
      a.app.onKeyPress('f9', () => {
        a.debug.timeScale = on(Te(a.debug.timeScale + 0.2, 0, 2), 1);
      }),
      a.app.onKeyPress('f10', () => a.debug.stepFrame())),
    a.globalOpt.burp && a.app.onKeyPress('b', () => ur()));
}
function ca(t, e = {}) {
  let n = a.game.root.add([Pt(t), lr()]),
    r = (e.speed || 1) * 5,
    o = e.scale || 1;
  n.add([fn(a.boomSprite), Ut(0), hn('center'), po(r, o), ...(e.comps ?? [])]);
  let s = n.add([
    fn(a.kaSprite),
    Ut(0),
    hn('center'),
  ...
  return (
    s.wait(0.4 / r, () => s.use(po(r, o))),
    s.onDestroy(() => n.destroy()),
    n
  );
}
function fo(t, e) {
...
function fn(t, e = {}) {
  ...
  return {
    ...
    add() {
      let c = Kt(t);
      c ? c.onLoad((p) => m(this, p)) : Nt(() => m(this, Kt(t).data));
    },
    update() {
...
function xa(t, e) {
  return {
    ...
    height: e,
    draw() {
      it(Object.assign(je(this), { width: this.width, height: this.height }));
    },
    renderArea() {
      return new W(v(0), this.width, this.height);
    },
      ...
      if (!(!e || !i || s) && (this.moveTo(i, n), this.pos.sdist(i) < 9))
        switch (r) {
          ...
          case 'stop':
            o < e.length - 1
              ? (o += 1)
              : s || ((s = !0), this.trigger('patrolFinished', this));
            break;
        }
    },
    onPatrolFinished(i) {
...
function Ea(t, e = {}) {
  let n = typeof t == 'function' ? t : () => a.game.root.query(t),
    ...
    o = typeof e.direction == 'number' ? E.fromAngle(e.direction) : e.direction,
    s = 0;
  return {
    id: 'sentry',
    require: ['pos'],
    ...
    hasLineOfSight(i) {
      let m = er(this.pos, i.pos.sub(this.pos), e.raycastExclude);
...
var bn = class {
  ...
  serialize() {
    ...
    return (
      ...
      this.easing != nt.linear && (e.easing = this.easing.name),
      this.interpolation !== 'linear' && (e.interpolation = this.interpolation),
      ...
      if ((super(e, r, o), (this.keys = n), this.interpolation === 'spline')) {
        ...
        for (let i = 0; i < this.keys.length - 1; i++) {
          let m = this.keys[i],
            u = i + 1,
            c = this.keys[u],
            p = i > 0 ? this.keys[i - 1] : Ta(c, m),
            b = u < this.keys.length - 1 ? this.keys[u + 1] : Ta(m, c);
          (this.curves.push(jt(p, m, c, b)),
            s && this.dcurves?.push(jt(p, m, c, b, Jo)));
        }
      }
    }
    update(e, n) {
    ...
    add() {
      a.game.root.wait(t, () => {
        ((this.opacity = this.opacity ?? 1),
          n > 0
            ? a.game.root
                .tween(this.opacity, 0, n, (r) => (this.opacity = r), nt.linear)
                .onEnd(() => {
                  this.destroy();
                })
            : this.destroy());
  ...
  return {
    ...
    enterState(u, ...c) {
      ...
      if (n) {
        ...
        if (!b.includes(u))
          throw new Error(
            `Cannot transition state from "${p}" to "${u}". Available transitions: ${b.map((l) => `"${l}"`).join(', ')}`,
          );
      }
      (i('end', p, ...c),
        (this.state = u),
    ...
    add() {
      ...
      ((n = a.k.onCharInput((s) => {
        ...
        (r = a.k.onKeyPressRepeat('backspace', () => {
          this.hasFocus &&
            ((this.typedText = this.typedText.slice(0, -1)), o());
        })));
    },
    destroy() {
      (n.cancel(), r.cancel());
...
function Ra(t = {}) {
  ...
  return {
    ...
    drawInspect() {
      ...
      let s = {
        outline: { width: 4 / _n(), color: I(0, 0, 255) },
        anchor: this.anchor,
        fill: !1,
        fixed: at(this),
      };
    ...
    isHovering() {
      let o = at(this) ? a.k.mousePos() : a.k.toWorld(a.k.mousePos());
    ...
    screenArea() {
      ...
      return at(this) ? o : o.transform(a.game.cam.transform);
    },
    inspect() {
      return this.area.scale?.x == this.area.scale?.y
        ? `area: ${this.area.scale?.x?.toFixed(1)}x`
        : `area: (${this.area.scale?.x?.toFixed(1)}x, ${this.area.scale.y?.toFixed(1)}y)`;
    },
  };
}
function Da(t = {}) {
  ...
  return {
    ...
    update() {
      ...
      u &&
        (this.pos.x == m.x &&
          ((this.pos.x = de(s.x, i.x, u / an())), (m.x = this.pos.x)),
        this.pos.y == m.y &&
          ((this.pos.y = de(s.y, i.y, u / an())), (m.y = this.pos.y)));
    },
    fixedUpdate() {
      if (
        (s &&
    ...
    jump(u) {
      this.isStatic ||
        ((e = null),
        (n = null),
        (this.vel = ht().scale(-u || -this.jumpForce)));
    },
    onGround(u) {
  ...
  return {
    ...
    add() {
      this.onCollideUpdate('body', (e, n) => {
        let r = e,
          o = r.worldArea(),
          [s, i] = o.cut(v(-100, this.surfaceLevel), v(100, this.surfaceLevel));
...
function Ha(t = {}) {
  ...
  return {
    ...
    isOffScreen() {
      ...
      return !Bt(n, s) && n.sdistToPoint(s) > i * i;
    },
    onExitScreen(s) {
    ...
    add() {
      t.pause && t.unpause ? rr(() => o(this)) : this.onUpdate(() => o(this));
    },
  };
}
function Pt(...t) {
  return {
    ...
    screenPos(e = null) {
      ...
      {
        let n = this.worldPos();
        return n ? (at(this) ? n : pn(n)) : null;
      }
    },
    toScreen(e) {
      let n = this.toWorld(e);
      return at(this) ? n : pn(n);
    },
    fromScreen(e) {
    ...
    drawInspect() {
      Ne({ color: I(255, 0, 0), radius: 4 / _n() });
    },
  };
}
function qa(t) {
...
var sc = Ao.version,
  ...
  ic = (t = { tagsAsComponents: !0 }) => {
    ...
    let l = b,
      h = ui(l, { texFilter: t.texFilter }),
      d = xi(t, h);
    a.gfx = d;
    let C = sa();
    a.audio = C;
    let g = zs(h, t.spriteAtlasPadding ?? 0);
    a.assets = g;
    let y = ea();
    ...
    function yn() {
      ...
      function ye(Q) {
        if (
          ...
          let ve = Q,
            ut = ve.worldArea().bbox(),
            dr = Math.floor(ut.pos.x / N),
            fr = Math.floor(ut.pos.y / N),
            hr = Math.ceil((ut.pos.x + ut.width) / N),
            gr = Math.ceil((ut.pos.y + ut.height) / N),
            wn = new Set();
          for (let Xe = dr; Xe <= hr; Xe++)
            for (let ct = fr; ct <= gr; ct++)
              if (!F[Xe]) ((F[Xe] = {}), (F[Xe][ct] = [ve]));
              else if (!F[Xe][ct]) F[Xe][ct] = [ve];
              else {
                let zt = F[Xe][ct];
                e: for (let Ie of zt) {
                  if (Ie.paused || !Ie.exists() || wn.has(Ie.id)) continue;
                  for (let Je of ve.collisionIgnore) if (Ie.is(Je)) continue e;
                  for (let Je of Ie.collisionIgnore) if (ve.is(Je)) continue e;
                  let Wt = ns(ve.worldArea(), Ie.worldArea());
                  if (Wt) {
                    let Je = new Ht(ve, Ie, Wt.normal, Wt.distance);
                    ve.trigger('collideUpdate', Ie, Je);
                    let Cn = Je.reverse();
                    ((Cn.resolved = Je.resolved),
                      Ie.trigger('collideUpdate', ve, Cn));
                  }
                  wn.add(Ie.id);
                }
                zt.push(ve);
    ...
    function xn(F) {
      ...
      let N =
        F.message ?? String(F) ?? 'Unknown error, check console for more info';
      c.run(
        () => {},
        () => {
          (A(),
          ...
          (F(),
            g.loaded ||
              (Be() === 1 &&
                !Mt &&
                ((g.loaded = !0),
                Un().forEach((z) => y.events.trigger('loadError', ...z)),
                y.events.trigger('load'))),
            (!g.loaded && t.loadingScreen !== !1) || Mt
              ? (A(), hi(), V())
              : (w.paused || Gt(),
                yn(),
                A(),
    ...
    let $e = {
      ...
      setGravity: ta,
      getGravity: na,
      setGravityDirection: ra,
      getGravityDirection: ht,
      setBackground: Is,
      getBackground: Ks,
    ...
    a.k = $e;
    let vn = t.plugins;
    if ((vn && vn.forEach(M), t.global !== !1))
      for (let F in $e) window[F] = $e[F];
    return (t.focus !== !1 && c.canvas.focus(), $e);
  };
var hw = ic;
export { a as _k, hw as default, ic as kaplay };
